 ...
 */
@Entity
@Table(name = "oauth_client_details", catalog = "boluclac_blog")
public class OauthClientDetails implements java.io.Serializable {
    ...
    public OauthClientDetails(String clientId, String resourceIds, String clientSecret, String scope, String authorizedGrantTypes,
            String webServerRedirectUri, String authorities, Integer accessTokenValidity, Integer refreshTokenValidity,
