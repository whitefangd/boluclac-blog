 ...
 */
@Entity
@Table(name = "clientdetails", catalog = "boluclac_blog")
public class Clientdetails implements java.io.Serializable {
    ...
    public Clientdetails(String appId, String resourceIds, String appSecret, String scope, String grantTypes, String redirectUrl,
