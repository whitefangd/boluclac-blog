 ...
 */
@Entity
@Table(name = "oauth_access_token", catalog = "boluclac_blog")
public class OauthAccessToken implements java.io.Serializable {
    ...
    public OauthAccessToken(String authenticationId, String tokenId, byte[] token, String userName, String clientId, byte[] authentication,
            String refreshToken) {
